...
// @Param data body model.CrmBusinessOpportunity true "创建商机管理"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmBusinessOpportunity true "删除商机管理"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除商机管理"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmBusinessOpportunity/deleteCrmBusinessOpportunity [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmBusinessOpportunity true "更新商机管理"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmBusinessOpportunity true "用id查询商机管理"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取商机管理列表"
