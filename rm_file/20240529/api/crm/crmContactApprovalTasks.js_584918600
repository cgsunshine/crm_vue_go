...
// @Param data body model.CrmContactApprovalTasks true "创建合同审批"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmContactApprovalTasks true "删除合同审批"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除合同审批"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmContactApprovalTasks/deleteCrmContactApprovalTasks [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmContactApprovalTasks true "更新合同审批"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmContactApprovalTasks true "用id查询合同审批"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取合同审批列表"
