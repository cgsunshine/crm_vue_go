...
// CreateCrmContactApprovalTasks 创建合同审批表
// @Tags CrmContactApprovalTasks
// @Summary 创建合同审批表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactApprovalTasks true "创建合同审批表"
...
// DeleteCrmContactApprovalTasks 删除合同审批表
// @Tags CrmContactApprovalTasks
// @Summary 删除合同审批表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactApprovalTasks true "删除合同审批表"
...
// DeleteCrmContactApprovalTasksByIds 批量删除合同审批表
// @Tags CrmContactApprovalTasks
// @Summary 批量删除合同审批表
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateCrmContactApprovalTasks 更新合同审批表
// @Tags CrmContactApprovalTasks
// @Summary 更新合同审批表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactApprovalTasks true "更新合同审批表"
...
// FindCrmContactApprovalTasks 用id查询合同审批表
// @Tags CrmContactApprovalTasks
// @Summary 用id查询合同审批表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmContactApprovalTasks true "用id查询合同审批表"
...
// GetCrmContactApprovalTasksPublic 不需要鉴权的合同审批表接口
// @Tags CrmContactApprovalTasks
// @Summary 不需要鉴权的合同审批表接口
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmContactApprovalTasksSearch true "分页获取合同审批表列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
