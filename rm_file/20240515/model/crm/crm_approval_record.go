...
type CrmApprovalRecord struct {
 global.GVA_MODEL 
      ...
      Message  string `json:"message" form:"message" gorm:"column:message;comment:审批相关信息或备注;"`  //审批相关信息或备注 
      ...
      流程状态  * `json:"流程状态" form:"流程状态" gorm:"column:流程状态;comment:审批状态;"`  //审批状态 
      ...
      ApproveOpinion  string `json:"approveOpinion" form:"approveOpinion" gorm:"column:approveOpinion;comment:审批意见;"`  //审批意见 
      FinalResult  string `json:"finalResult" form:"finalResult" gorm:"column:finalResult;type:enum();comment:最终审批结果;"`  //最终审批结果 
      ...
      IsDeleted  * `json:"isDeleted" form:"isDeleted" gorm:"column:isDeleted;comment:逻辑删除标志;"`  //逻辑删除标志 
}
