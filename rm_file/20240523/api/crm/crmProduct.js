...
// @Param data body model.CrmProduct true "创建产品管理"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmProduct true "删除产品管理"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除产品管理"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmProduct/deleteCrmProduct [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmProduct true "更新产品管理"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmProduct true "用id查询产品管理"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取产品管理列表"
