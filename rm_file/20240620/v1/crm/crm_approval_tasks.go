...
// CreateCrmApprovalTasks 创建crmApprovalTasks表
// @Tags CrmApprovalTasks
// @Summary 创建crmApprovalTasks表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalTasks true "创建crmApprovalTasks表"
...
// DeleteCrmApprovalTasks 删除crmApprovalTasks表
// @Tags CrmApprovalTasks
// @Summary 删除crmApprovalTasks表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalTasks true "删除crmApprovalTasks表"
...
// DeleteCrmApprovalTasksByIds 批量删除crmApprovalTasks表
// @Tags CrmApprovalTasks
...
// UpdateCrmApprovalTasks 更新crmApprovalTasks表
// @Tags CrmApprovalTasks
// @Summary 更新crmApprovalTasks表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalTasks true "更新crmApprovalTasks表"
...
// FindCrmApprovalTasks 用id查询crmApprovalTasks表
// @Tags CrmApprovalTasks
// @Summary 用id查询crmApprovalTasks表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmApprovalTasks true "用id查询crmApprovalTasks表"
...
// GetCrmApprovalTasksList 分页获取crmApprovalTasks表列表
// @Tags CrmApprovalTasks
// @Summary 分页获取crmApprovalTasks表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmApprovalTasksSearch true "分页获取crmApprovalTasks表列表"
...
// GetCrmApprovalTasksPublic 不需要鉴权的crmApprovalTasks表接口
// @Tags CrmApprovalTasks
// @Summary 不需要鉴权的crmApprovalTasks表接口
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmApprovalTasksSearch true "分页获取crmApprovalTasks表列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (crmApprovalTasksApi *CrmApprovalTasksApi) GetCrmApprovalTasksPublic(c *gin.Context) {
    ...
    response.OkWithDetailed(gin.H{
       "info": "不需要鉴权的crmApprovalTasks表接口信息",
    }, "获取成功", c)
}
