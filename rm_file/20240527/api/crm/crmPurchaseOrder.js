...
// @Param data body model.CrmPurchaseOrder true "创建crmPurchaseOrder表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmPurchaseOrder true "删除crmPurchaseOrder表"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除crmPurchaseOrder表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmPurchaseOrder/deleteCrmPurchaseOrder [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmPurchaseOrder true "更新crmPurchaseOrder表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmPurchaseOrder true "用id查询crmPurchaseOrder表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取crmPurchaseOrder表列表"
