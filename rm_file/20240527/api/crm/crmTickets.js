...
// @Param data body model.CrmTickets true "创建crmTickets表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmTickets true "删除crmTickets表"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除crmTickets表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmTickets/deleteCrmTickets [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmTickets true "更新crmTickets表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmTickets true "用id查询crmTickets表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取crmTickets表列表"
