...
// CreateCrmTickets 创建crmTickets表
// @Tags CrmTickets
// @Summary 创建crmTickets表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmTickets true "创建crmTickets表"
...
// DeleteCrmTickets 删除crmTickets表
// @Tags CrmTickets
// @Summary 删除crmTickets表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmTickets true "删除crmTickets表"
...
// DeleteCrmTicketsByIds 批量删除crmTickets表
// @Tags CrmTickets
// @Summary 批量删除crmTickets表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
...
// UpdateCrmTickets 更新crmTickets表
// @Tags CrmTickets
// @Summary 更新crmTickets表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmTickets true "更新crmTickets表"
...
// FindCrmTickets 用id查询crmTickets表
// @Tags CrmTickets
// @Summary 用id查询crmTickets表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmTickets true "用id查询crmTickets表"
...
// GetCrmTicketsList 分页获取crmTickets表列表
// @Tags CrmTickets
// @Summary 分页获取crmTickets表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmTicketsSearch true "分页获取crmTickets表列表"
...
// GetCrmTicketsPublic 不需要鉴权的crmTickets表接口
// @Tags CrmTickets
// @Summary 不需要鉴权的crmTickets表接口
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmTicketsSearch true "分页获取crmTickets表列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
