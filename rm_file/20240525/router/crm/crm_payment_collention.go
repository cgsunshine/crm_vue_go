...
func (s *CrmPaymentCollentionRouter) InitCrmPaymentCollentionRouter(Router *gin.RouterGroup, PublicRouter *gin.RouterGroup) {
	...
	}
	{
		...
		//crmPaymentCollentionRouterWithoutRecord.GET("getPageCrmPaymentCollentionList", crmPaymentCollentionApi.GetPageCrmPaymentCollentionList) // 获取crmPaymentCollention表列表
	}
	{
