...
// CreateCrmApprovalNode 创建节点审批
// @Tags CrmApprovalNode
// @Summary 创建节点审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalNode true "创建节点审批"
...
// DeleteCrmApprovalNode 删除节点审批
// @Tags CrmApprovalNode
// @Summary 删除节点审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalNode true "删除节点审批"
...
// DeleteCrmApprovalNodeByIds 批量删除节点审批
// @Tags CrmApprovalNode
// @Summary 批量删除节点审批
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateCrmApprovalNode 更新节点审批
// @Tags CrmApprovalNode
// @Summary 更新节点审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalNode true "更新节点审批"
...
// FindCrmApprovalNode 用id查询节点审批
// @Tags CrmApprovalNode
// @Summary 用id查询节点审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmApprovalNode true "用id查询节点审批"
...
// GetCrmApprovalNodeList 分页获取节点审批列表
// @Tags CrmApprovalNode
// @Summary 分页获取节点审批列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmApprovalNodeSearch true "分页获取节点审批列表"
...
// GetCrmApprovalNodePublic 不需要鉴权的节点审批接口
// @Tags CrmApprovalNode
// @Summary 不需要鉴权的节点审批接口
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmApprovalNodeSearch true "分页获取节点审批列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
