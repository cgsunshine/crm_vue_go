...
// DeleteCrmApprovalNode 删除审批节点
// @Tags CrmApprovalNode
// @Summary 删除审批节点
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalNode true "删除审批节点"
...
// DeleteCrmApprovalNodeByIds 批量删除审批节点
// @Tags CrmApprovalNode
// @Summary 批量删除审批节点
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateCrmApprovalNode 更新审批节点
// @Tags CrmApprovalNode
// @Summary 更新审批节点
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmApprovalNode true "更新审批节点"
...
// FindCrmApprovalNode 用id查询审批节点
// @Tags CrmApprovalNode
// @Summary 用id查询审批节点
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmApprovalNode true "用id查询审批节点"
...
// GetCrmApprovalNodeList 分页获取审批节点列表
// @Tags CrmApprovalNode
// @Summary 分页获取审批节点列表
// @Security ApiKeyAuth
// @accept application/json
...
// GetCrmApprovalNodePublic 不需要鉴权的审批节点接口
// @Tags CrmApprovalNode
