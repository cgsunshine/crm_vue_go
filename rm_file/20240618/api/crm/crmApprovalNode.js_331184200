...
// @Param data body model.CrmApprovalNode true "创建节点审批"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmApprovalNode true "删除节点审批"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除节点审批"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmApprovalNode/deleteCrmApprovalNode [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmApprovalNode true "更新节点审批"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmApprovalNode true "用id查询节点审批"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取节点审批列表"
