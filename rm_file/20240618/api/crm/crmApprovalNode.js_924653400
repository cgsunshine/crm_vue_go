...
// @Param data body model.CrmApprovalNode true "创建审批节点"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmApprovalNode true "删除审批节点"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除审批节点"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmApprovalNode/deleteCrmApprovalNode [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmApprovalNode true "更新审批节点"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmApprovalNode true "用id查询审批节点"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取审批节点列表"
