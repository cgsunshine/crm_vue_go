...
// 对账单 结构体  CrmStatementAccount
type CrmStatementAccount struct {
 global.GVA_MODEL 
      PurchaseOrderId  *int `json:"purchaseOrderId" form:"purchaseOrderId" gorm:"column:purchase_order_id;comment:订购单ID;size:10;"`  //订购单ID 
...
// TableName 对账单 CrmStatementAccount自定义表名 crm_statement_account
