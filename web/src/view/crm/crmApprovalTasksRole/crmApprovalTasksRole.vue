<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="审批状态" prop="approvalStatus">
         <el-input v-model="searchInfo.approvalStatus" placeholder="搜索条件" />
        ...
        <el-form-item label="审批意见" prop="comments">
         <el-input v-model="searchInfo.comments" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="审批人id" prop="assigneeId" width="120" />
        ...
        <el-table-column align="left" label="审批角色id" prop="roleId" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateCrmApprovalTasksRoleFunc(scope.row)">变更</el-button>
    ...
    <el-drawer size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #title>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="审批人id:"  prop="assigneeId" >
              <el-input v-model.number="formData.assigneeId" :clearable="true" placeholder="请输入审批人id" />
            </el-form-item>
            <el-form-item label="关联id 合同 商机 回款:"  prop="associatedId" >
            ...
            <el-form-item label="审批角色id:"  prop="roleId" >
              <el-input v-model.number="formData.roleId" :clearable="true" placeholder="请输入审批角色id" />
            </el-form-item>
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" title="查看详情" destroy-on-close>
        ...
        <el-descriptions :column="1" border>
                ...
                <el-descriptions-item label="审批角色id">
                        {{ formData.roleId }}
                </el-descriptions-item>
...
import {
  ...
  deleteCrmApprovalTasksRole,
  deleteCrmApprovalTasksRoleByIds,
  updateCrmApprovalTasksRole,
  findCrmApprovalTasksRole,
  getCrmApprovalTasksRoleList
...
const getTableData = async() => {
  const table = await getCrmApprovalTasksRoleList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const deleteRow = (row) => {
    ElMessageBox.confirm('确定要删除吗?', '提示', {
        ...
        type: 'warning'
            ...
            deleteCrmApprovalTasksRoleFunc(row)
        })
    }
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteCrmApprovalTasksRoleByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateCrmApprovalTasksRoleFunc = async(row) => {
    const res = await findCrmApprovalTasksRole({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteCrmApprovalTasksRoleFunc = async (row) => {
    const res = await deleteCrmApprovalTasksRole({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
