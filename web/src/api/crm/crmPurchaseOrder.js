...
// @Param data body model.CrmPurchaseOrder true "创建订购单管理"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmPurchaseOrder true "删除订购单管理"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除订购单管理"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmPurchaseOrder/deleteCrmPurchaseOrder [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmPurchaseOrder true "更新订购单管理"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmPurchaseOrder true "用id查询订购单管理"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取订购单管理列表"
