...
// @Param data body model.CrmContactFile true "创建合同文件"
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmContactFile true "删除合同文件"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除合同文件"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /crmContactFile/deleteCrmContactFile [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.CrmContactFile true "更新合同文件"
...
// @accept application/json
// @Produce application/json
// @Param data query model.CrmContactFile true "用id查询合同文件"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取合同文件列表"
