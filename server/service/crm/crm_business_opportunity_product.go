...
// CreateCrmBusinessOpportunityProducts 创建crmBusinessOpportunityProduct表记录
// Author [piexlmax](https://github.com/piexlmax)
func (crmBusinessOpportunityProductService *CrmBusinessOpportunityProductService) CreateCrmBusinessOpportunityProducts(crmBusinessOpportunityProducts []*crm.CrmBusinessOpportunityProduct) (err error) {
	err = global.GVA_DB.Create(crmBusinessOpportunityProducts).Error
	return err
}
...
// DeleteCrmBusinessOpportunityProduct 删除crmBusinessOpportunityProduct表记录
// Author [piexlmax](https://github.com/piexlmax)
func (crmBusinessOpportunityProductService *CrmBusinessOpportunityProductService) DeleteCrmBusinessOpportunityIdProduct(businessOpportunityId *int) (err error) {
	err = global.GVA_DB.Delete(&crm.CrmBusinessOpportunityProduct{}, "business_opportunity_id = ?", businessOpportunityId).Error
	return err
}
