...
// CreateCrmPurchaseOrder 创建crmPurchaseOrder表记录
...
// DeleteCrmPurchaseOrder 删除crmPurchaseOrder表记录
// Author [piexlmax](https://github.com/piexlmax)
...
// DeleteCrmPurchaseOrderByIds 批量删除crmPurchaseOrder表记录
// Author [piexlmax](https://github.com/piexlmax)
...
// UpdateCrmPurchaseOrder 更新crmPurchaseOrder表记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetCrmPurchaseOrder 根据ID获取crmPurchaseOrder表记录
// Author [piexlmax](https://github.com/piexlmax)
