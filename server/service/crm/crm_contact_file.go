...
// DeleteCrmContactFileByIds 批量删除合同文件记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetCrmContactFile 根据ID获取合同文件记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetCrmContactFileInfoList 分页获取合同文件记录
// Author [piexlmax](https://github.com/piexlmax)
