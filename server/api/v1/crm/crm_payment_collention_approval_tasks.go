...
// CreateCrmPaymentCollentionApprovalTasks 创建回款审批
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 创建回款审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmPaymentCollentionApprovalTasks true "创建回款审批"
...
// DeleteCrmPaymentCollentionApprovalTasks 删除回款审批
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 删除回款审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmPaymentCollentionApprovalTasks true "删除回款审批"
...
// DeleteCrmPaymentCollentionApprovalTasksByIds 批量删除回款审批
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 批量删除回款审批
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateCrmPaymentCollentionApprovalTasks 更新回款审批
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 更新回款审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmPaymentCollentionApprovalTasks true "更新回款审批"
...
// FindCrmPaymentCollentionApprovalTasks 用id查询回款审批
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 用id查询回款审批
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmPaymentCollentionApprovalTasks true "用id查询回款审批"
...
// GetCrmPaymentCollentionApprovalTasksList 分页获取回款审批列表
// @Tags CrmPaymentCollentionApprovalTasks
// @Summary 分页获取回款审批列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmPaymentCollentionApprovalTasksSearch true "分页获取回款审批列表"
...
// GetCrmPaymentCollentionApprovalTasksPublic 不需要鉴权的回款审批接口
// @Tags CrmPaymentCollentionApprovalTasks
