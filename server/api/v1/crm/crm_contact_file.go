...
// CreateCrmContactFile 创建合同文件
// @Tags CrmContactFile
// @Summary 创建合同文件
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactFile true "创建合同文件"
...
// DeleteCrmContactFile 删除合同文件
// @Tags CrmContactFile
// @Summary 删除合同文件
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactFile true "删除合同文件"
...
// DeleteCrmContactFileByIds 批量删除合同文件
// @Tags CrmContactFile
// @Summary 批量删除合同文件
// @Security ApiKeyAuth
// @accept application/json
...
// UpdateCrmContactFile 更新合同文件
// @Tags CrmContactFile
// @Summary 更新合同文件
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmContactFile true "更新合同文件"
...
// FindCrmContactFile 用id查询合同文件
// @Tags CrmContactFile
// @Summary 用id查询合同文件
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crm.CrmContactFile true "用id查询合同文件"
...
// GetCrmContactFileList 分页获取合同文件列表
// @Tags CrmContactFile
// @Summary 分页获取合同文件列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmContactFileSearch true "分页获取合同文件列表"
...
// GetCrmContactFilePublic 不需要鉴权的合同文件接口
// @Tags CrmContactFile
