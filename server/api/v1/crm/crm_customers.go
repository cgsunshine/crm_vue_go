...
// DeleteCrmCustomers 删除crmCustomers表
// @Tags CrmCustomers
// @Summary 删除crmCustomers表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmCustomers true "删除crmCustomers表"
...
// DeleteCrmCustomersByIds 批量删除crmCustomers表
// @Tags CrmCustomers
...
// UpdateCrmCustomers 更新crmCustomers表
// @Tags CrmCustomers
// @Summary 更新crmCustomers表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body crm.CrmCustomers true "更新crmCustomers表"
...
// FindCrmCustomers 用id查询crmCustomers表
// @Tags CrmCustomers
...
// GetCrmCustomersList 分页获取crmCustomers表列表
// @Tags CrmCustomers
// @Summary 分页获取crmCustomers表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmCustomersSearch true "分页获取crmCustomers表列表"
...
// GetCrmCustomersPublic 不需要鉴权的crmCustomers表接口
// @Tags CrmCustomers
// @Summary 不需要鉴权的crmCustomers表接口
// @accept application/json
// @Produce application/json
// @Param data query crmReq.CrmCustomersSearch true "分页获取crmCustomers表列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
