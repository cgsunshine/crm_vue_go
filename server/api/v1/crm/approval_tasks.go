...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /crmApprovalTasks/getCrmApprovalTasksList [get]
func (crmApprovalTasksApi *CrmApprovalTasksApi) GetCrmDepositsApprovalTasksList(c *gin.Context) {
	var pageInfo crmReq.CrmApprovalTasksSearch
	err := c.ShouldBindQuery(&pageInfo)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /crmApprovalTasks/getCrmApprovalTasksList [get]
func (crmApprovalTasksApi *CrmApprovalTasksApi) GetCrmStatementAccountApprovalTasksList(c *gin.Context) {
	var pageInfo crmReq.CrmApprovalTasksSearch
	err := c.ShouldBindQuery(&pageInfo)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (crmApprovalTasksApi *CrmApprovalTasksApi) GetCrmPaymentApprovalTasksList(c *gin.Context) {
	var pageInfo crmReq.CrmApprovalTasksSearch
	err := c.ShouldBindQuery(&pageInfo)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"更新成功"}"
// @Router /crmContactApprovalTasks/updateCrmContactApprovalTasks [put]
func (crmApprovalTasksApi *CrmApprovalTasksApi) UpdateCrmMultipleApprovalTasksBack(c *gin.Context) {
	var CrmApprovalTasks crm.CrmApprovalTasks
	err := c.ShouldBindJSON(&CrmApprovalTasks)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"查询成功"}"
// @Router /crmContactApprovalTasks/findCrmContactApprovalTasks [get]
func (crmApprovalTasksApi *CrmApprovalTasksApi) FindCrmPageDepositsApprovalTasks(c *gin.Context) {
	ID := c.Query("ID")
