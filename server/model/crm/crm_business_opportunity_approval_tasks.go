...
type CrmBusinessOpportunityApprovalTasks struct {
 global.GVA_MODEL 
...
// TableName 商机审批 CrmBusinessOpportunityApprovalTasks自定义表名 crm_business_opportunity_approval_tasks
func (CrmBusinessOpportunityApprovalTasks) TableName() string {
  return "crm_business_opportunity_approval_tasks"
}
