...
type CrmPageBusinessOpportunity struct {
	...
	BusinessOpportunityNumber string     `json:"businessOpportunityNumber" form:"businessOpportunityNumber" gorm:"column:business_opportunity_number;comment:商机名称;size:191;"` //商机编号
