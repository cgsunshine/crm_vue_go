...
type CrmPageBusinessOpportunity struct {
	...
	Products                []CrmProduct `gorm:"many2many:crm_business_opportunity_product;foreignKey:id;joinForeignKey:businessOpportunityId;References:id;joinReferences:ProductId"`
	//以下是联表字段
	//sys_user 表
