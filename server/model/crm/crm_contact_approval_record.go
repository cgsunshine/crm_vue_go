...
type CrmContactApprovalRecord struct {
 global.GVA_MODEL 
      ...
      ApproverId  *int `json:"approverId" form:"approverId" gorm:"column:approver_id;comment:当前审批人ID;size:10;"`  //当前审批人ID 
      ContactId  *int `json:"contactId" form:"contactId" gorm:"column:contact_id;comment:合同id;"`  //合同id 
